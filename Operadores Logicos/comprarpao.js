...
dinheiro1 = parseFloat(
  readline.question(nome1 + ' quanto voce possui de dinheiro? ')
)

nome2 = readline.question('Qual seu nome? ')
dinheiro2 = parseFloat(
  readline.question(nome2 + ' quanto voce possui de dinheiro? ')
)
...
if (dinheiro1 >= totalpao || dinheiro2 >= totalpao) {
  ...
  console.log('Nao temos dinheiro para comprar pao')
}
